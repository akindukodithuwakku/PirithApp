...
const websitePath = path.join(__dirname, '..', 'website', 'public', 'build-info.json');
...
console.log('💡 Example: node scripts/manual-build-info.js 986805a3-1e51-4c9e-82ff-8b89f575a6e9'); 